...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.7\linewidth]{IMG/ch3/LABVIEW}
...
\noindent In the MoVe\_IT project are used FPGA boards like the one in figure \ref{fig:kintex}, a Xilinx Kintex 7 kc705 development board.
\begin{figure}[H]
	\centering
	\includegraphics[width=0.7\linewidth]{IMG/ch3/KINTEX}
