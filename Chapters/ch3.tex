...
This means that when probing the two wires of a LVDS25 signal the two voltages to be expected are $Q$=1.600~V and $\bar{Q}$=0.900~V.
\begin{figure}[H]
	\centering
