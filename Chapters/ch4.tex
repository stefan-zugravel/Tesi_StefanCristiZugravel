...
\begin{figure}[H]
	...
	\label{fig:fsmFIFO1}
\end{figure}
\noindent In order to send the data to the computer in the correct order another FIFO is implemented for storing all the replies strings. %This is done in the \textit{Send Reply} state.
\begin{figure}[H]
	\centering
