...
\noindent In order to better visualize the improvement in accuracy the following plot have been generated. In red it can bee seen the histogram of the CPU generated rates, while in black it can be seen the FPGA generated rates. The comparison has been made on the 100~ms integration time case with 1~MHz pulsed rate. The improvement is remarkable and can be seen in figure \ref{fig:FPGA_and_CPU_rate_1MHz_100ms}. 
\begin{figure}[H]
	\centering
